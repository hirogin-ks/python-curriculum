...
### 23.3 問題1：loguru でスクレイピングのログを記録する
...
### 23.4 問題2：parser.py と test_parser.py を作る
...
### 23.6 問題4：loguru と pytest を組み合わせる
